<?php namespace Cms\Library\Helpers\ColorAnalizer;

use Cms\Library\Helpers\ColorAnalizer\Image\Histogram\ColorHistogram;
use Cms\Library\Helpers\ColorAnalizer\Color\Color;
use Cms\Library\Helpers\ColorAnalizer\Image\Manipulation\Scale;
...
class Analyzer
{
    ...
    {
        $this->image = Image\Image::createFromFile($image);
