...
class EntityAttribute extends Eloquent {
	 ...
	 * @var array
	 */
	protected $columns = ['id', 'created_at', 'updated_at', 'entity_id', 'name', 'type', 'validations', 'options', 'description'];
	...
	protected $rules = [
        ...
        'type' => 'required|in:string,text,integer,image,image_array,slug,markdown',
    ];
