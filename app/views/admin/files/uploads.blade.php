		...
		<div class="" ng-show="uploads.length > 0">
			...
			<div ng-repeat="upload in uploads">
				...
				<div ng-show="!upload.hidden" class="">
					...
					<button class="pull-right btn btn-danger btn-xs" ng-show="upload.active" ng-click="upload.cancel()">Abort</button>
					<button class="pull-right btn btn-default btn-xs" ng-show="!upload.active" ng-click="upload.hide()">Hide</button>
